...
/**
 * Balanced source list — 18 sources across the political spectrum.
 * 4 center/wire, 4 lean-left, 3 lean-right, 2 defense/center, 5 regional/non-Western.
 *
...
export const NEWS_SOURCES: NewsSource[] = [
  ...
  // ── Lean Right / Right ──
  {
    id: "fox",
    name: "Fox News",
    url: "https://www.foxnews.com/category/politics/defense/wars/war-with-iran",
    bias: "lean-right",
    region: "us",
    reliability: "mixed",
  },
