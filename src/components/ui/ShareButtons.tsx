  ...
  return (
    <div className="flex items-center gap-3">
      ...
      {typeof navigator !== "undefined" && "share" in navigator && (
        <button onClick={share} className="text-zinc-500 hover:text-white transition-colors" aria-label="Share">
      ...
      {/* Copy link */}
      <button onClick={copy} className="text-zinc-500 hover:text-white transition-colors" aria-label="Copy link">
        {copied ? (
