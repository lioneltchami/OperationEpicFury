        ...
        <div>
          ...
          <div className="mt-12 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href="https://substack.com/@tlionel"
                target="_blank"
                rel="noopener noreferrer"
                className="text-zinc-500 hover:text-white transition-colors"
                aria-label="Substack"
          ...
          <div className="mt-8 pt-6 border-t border-white/5 flex flex-wrap items-center gap-4 text-[11px]">
            ...
            {process.env.NEXT_PUBLIC_KOFI_URL && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`inline-flex items-center gap-1.5 px-3 py-1.5 bg-red-600/20 border border-red-500/30 rounded-full text-red-400 hover:bg-red-600/30 hover:text-red-300 transition-colors ${monoClass}`}
              >
                <svg
